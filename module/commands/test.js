...
module.exports = {
  config: {
    ...
    hasPermssion: 0, // Set the required permission level (0 for normal users, 1 for admin)
    // Other configuration properties https://replit.com/@bgfxd/chei#module/commands/test.js
  },
