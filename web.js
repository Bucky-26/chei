...
// Rest of your code and bot setup...
...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ ISOY DEV ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "reygie.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
axios.get("https://raw.githubusercontent.com/Bucky-26/Listban/main/package.json").then((res) => {
